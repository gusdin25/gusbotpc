...
Contoh : *${prefix}tiktokstalk @gusdin_*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}igstalk @gusdin_*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}smulestalk @gusdin_*
...
╠➥ *NAME : GUS BOT*
╠➥ *VERSION : 3.0*
╠➥ *GITHUB : github.com/gusdin25*
╠➥ *TEAM : @auzora_creative*
║
╚═〘 GUS BOT 〙
`
}
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *GUS Bot*
...
║
╠➥ *DONASI BISA MELALUI :*
╠➥ *DANA/OVO : 081997826183*
╠➥ *SAWERIA : saweria.co/gusdin*
